...
inFileDir = "/eos/home-c/chensh/JPsiJPsi/GEN_nofilter/DPS/ULPythia2016/CMSSW_10_2_5/src/4mu_acc/direct/"
...
revt_mass = "GENevt_mass[0]"

# Event-level cuts:
# N1: both J/psi satisfy |y| < 1.2 and 20 < pT < 40
# N2: both J/psi satisfy |y| < 2.0 and 10 < pT < 40 and m > 7.5
cut_n1 = (
...
cut_n2 = (
    ...
    "{pt1} > 10 && {pt1} < 40 && {pt2} > 10 && {pt2} < 40 && {m} > 7.5"
).format(y1=rJpsi1_y, y2=rJpsi2_y, pt1=rJpsi1_pt, pt2=rJpsi2_pt, m=revt_mass)
