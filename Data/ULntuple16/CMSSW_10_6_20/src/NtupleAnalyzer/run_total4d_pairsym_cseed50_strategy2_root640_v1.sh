...
run_tag="${1:-newdata167_accmix23_effmix19_lumi36p684_pairsym_cseed50_root640_strategy2_v1_20260902}"
...
root -l -b -q 'Fit_4D_tot.cpp(true,false,false,true,false,2)' > logs/reference.log 2>&1
end_epoch="$(date +%s)"
...

{
    ...
    echo "task=total_4d_newdata167_accmix23_effmix19_pairsym_cseed50_root640_strategy2_v1"
...
echo "TOTAL4D_PAIRSYM_STRATEGY2_COMPLETE result=${total_dir}/total_fit_summary.csv"
