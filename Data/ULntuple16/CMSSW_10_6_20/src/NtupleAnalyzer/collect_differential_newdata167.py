...
def main():
    ...
    lines = [
        ...
        "total_correction_systematic_relative=0.08805293089840492",
        f"accepted_sys3_source={source_sys3}",
        f"accepted_sys3_sha256={sha256(source_sys3)}",
        "correction_fallback_note=four sparse bins use the accepted DPS-only fallback; undefined SPS closure is not treated as zero",
