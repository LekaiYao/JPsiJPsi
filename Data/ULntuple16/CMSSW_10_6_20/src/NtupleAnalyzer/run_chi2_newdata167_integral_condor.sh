...
bin_step=5
base_seed=20260902
campaign_tag="gof_root640_chi2_integral_newdata167_accmix23_effmix19_v1_20260902"
...
root -l -b -q "Fit_Check.cpp+(0,0,\"${result_tag}\",${base_seed},${projection_bins},false,\"${weight_data}\",\"${model_file}\",\"${fit_result_file}\")"
