...
void build_crossslot_splot_mixed(
    ...
    const char *input1=
        "tests/atlas_data_driven_sps/results/route9p3_crossslot_splot/jpsi1_sweights.root",
    const char *input2=
        "tests/atlas_data_driven_sps/results/route9p3_crossslot_splot/jpsi2_sweights.root",
    const char *output=
        "tests/atlas_data_driven_sps/results/route9p3_crossslot_allpairs/mixed_dps_allpairs.root") {
