...
void fit_single_jpsi_global_calibrated_splot(
    ...
    const char *output=
        "Data_driven/results/fdps_systematics_final_v1/category/global_calibrated/jpsi1_sweights.root") {
  ...
  RooDataSet data("data","unweighted selected global candidates",observables,
                  Import(*tree));
